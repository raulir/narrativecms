function cms_input_date_init($root){

	var $scope = $root ? $root.find('.cms_input_date') : $('.cms_input_date');

	$scope.not('.cms_input_date_ok').each(function(){

		var $parent = $(this);
		var $this = $('.cms_input_date_input', $parent);

		if (!$this.hasClass('cms_input_date_input_hidden')){
			return;
		}

		$parent.addClass('cms_input_date_ok');
