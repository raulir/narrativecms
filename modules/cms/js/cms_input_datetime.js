function cms_input_datetime_init($root){

	var $scope = $root ? $root.find('.cms_input_datetime') : $('.cms_input_datetime');

	$scope.not('.cms_input_datetime_ok').each(function(){
		...
		$this.addClass('cms_input_datetime_ok');
