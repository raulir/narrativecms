function cms_input_file_rename(old_name){
	
	// TODO: check if such name exists on page
	
	var new_name = ('0000'+Math.random().toString(36).replace('.', '')).substr(-5);
	
	$('.cms_input_file_container_' + old_name + ' label').attr({'for':'cms_input_file_' + new_name});
	$('.cms_input_file_container_' + old_name + ' .cms_file_content').removeClass('cms_input_file_content_' + old_name).addClass('cms_input_file_content_' + new_name);
	$('.cms_input_file_container_' + old_name + ' .cms_input_button').data('name', new_name);
	$('.cms_input_file_container_' + old_name + ' input').removeClass('cms_file_input_' + old_name).addClass('cms_file_input_' + new_name);
	
	$('.cms_input_file_container_' + old_name).removeClass('cms_input_file_container_' + old_name).addClass('cms_input_file_container_' + new_name);
