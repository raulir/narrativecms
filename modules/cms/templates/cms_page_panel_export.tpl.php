<?php if (!empty($export_view) && $export_view === 'settings'): ?>

	<?php include __DIR__.'/cms_page_panel_export_settings.tpl.php'; ?>
...
<div class="cms_page_panel_export_container">
	...
	<div class="cms_page_panel_export_content">
		...
		<?php if (!empty($stats['panel_files']['count'])): ?>
		<div class="cms_page_panel_export_col1">Panel files</div>
		<div class="cms_page_panel_export_col2"><?= $stats['panel_files']['count'] ?></div>
		<div class="cms_page_panel_export_col3"><?= $stats['panel_files']['size'] ?></div>
		<?php endif ?>
