...
<div class="cms_input cms_input_area">
	...
	<div class="cms_input_content cms_input_groups">
		...
		<div class="cms_input_groups_values">
			<?php foreach($values as $key => $val): ?>
				<div class="cms_input_groups_value cms_input_groups_value_<?= $key ?> <?= $key == $value ? ' cms_input_groups_value_selected ' : '' ?>"
						data-value="<?= $key ?>"><?= $val ?></div>
			<?php endforeach ?>
		</div>
