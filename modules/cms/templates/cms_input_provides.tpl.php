...
?>
<div class="cms_input cms_input_select cms_input_provides <?= !empty($mandatory_class) ? $mandatory_class : '' ?>
		<?= !empty($extra_class) ? $extra_class : '' ?>"
		data-cms_input_height="1"
		data-service="<?= htmlspecialchars($service ?? ($params['service'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
