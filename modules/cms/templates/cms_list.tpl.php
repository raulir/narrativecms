<div class="cms_toolbar">
	...
	<div class="cms_tool_button admin_right cms_paging_button cms_paging_last" <?php _ib('cms/cms_paging_last.png', ['height' => 12]) ?>></div>
	<div class="cms_tool_button admin_right cms_paging_button cms_paging_next" <?php _ib('cms/cms_paging_next.png', ['height' => 12]) ?>></div>

	<div class="cms_tool_text admin_right">
		<span class="admin_paging_current">&nbsp;&nbsp;</span>/<span class="admin_paging_total">&nbsp;&nbsp;</span>
	</div>

	<div class="cms_tool_button admin_right cms_paging_button cms_paging_previous" <?php _ib('cms/cms_paging_previous.png', ['height' => 12]) ?>></div>
	<div class="cms_tool_button admin_right cms_paging_button cms_paging_first" <?php _ib('cms/cms_paging_first.png', ['height' => 12]) ?>></div>
