<div class="cms_input cms_input_datetime cms_input_datetime_hidden <?= !empty($extra_class) ? $extra_class : '' ?> 
		<?= !empty($mandatory) ? ' cms_input_mandatory ' : '' ?>" 
		<?= !empty($default) ? ' data-default="'.$default.'" ' : '' ?>
		<?= !empty($format) ? ' data-format="timestamp" ' : '' ?>>
	...
	<input type="date" class="cms_input_datetime_date" <?php _ib('cms/cms_calendar.png', 20) ?>>
	
	<div class="cms_input_datetime_time">
