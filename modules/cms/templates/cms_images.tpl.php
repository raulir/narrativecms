<div class="popup_container cms_images_container" style="display: none; ">
	<div class="cms_images_content">
		...
		<div class="cms_toolbar cms_images_toolbar">
			...
			<a class="cms_images_select cms_tool_button admin_right popup_select" data-value="<?= $filename ?>">Select</a>
			
			<a class="cms_images_cancel cms_tool_button admin_right popup_cancel">Cancel</a>
			
			<a class="cms_images_upload cms_tool_button admin_right">Upload</a>
			...
			<div class="cms_tool_button admin_right cms_paging_button cms_paging_last cms_images_paging_last cms_images_paging_disabled"
					<?php _ib('cms/cms_paging_last.png', ['height' => 12]) ?>></div>
			<div class="cms_tool_button admin_right cms_paging_button cms_paging_next cms_images_paging_next cms_images_paging_disabled"
			...
			<div class="cms_tool_button admin_right cms_paging_button cms_paging_previous cms_images_paging_previous cms_images_paging_disabled"
					<?php _ib('cms/cms_paging_previous.png', ['height' => 12]) ?>></div>
			<div class="cms_tool_button admin_right cms_paging_button cms_paging_first cms_images_paging_first cms_images_paging_disabled"
			...
			<input class="cms_images_search_input admin_right" placeholder="Search ...">
