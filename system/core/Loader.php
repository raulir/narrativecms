...
class Loader {
	...
	/**
	 * Database loader — attaches cms_db on the main controller as $CI->db.
	 * Uses $GLOBALS['db'] (mysqli) from cms_config_load_full(). No multi-driver / AR.
	 *
	 * @param	string	unused (kept for call-site compatibility)
	 * @param	bool	whether to return the cms_db instance instead of attaching
	 * @param	mixed	unused
	 * @return	cms_db|false
	 */
	public function database($params = '', $return = FALSE, $active_record = NULL)
	{
		...
		if ($return === FALSE && isset($CI->db) && $CI->db instanceof cms_db)
		{
			return FALSE;
		}
